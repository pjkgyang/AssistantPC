            ...
            <div class="dialog-pj">
                <section> 
					<p >
						...
						<el-input v-model="qrls" size="mini" placeholder="请输入内容" style="width:600px"></el-input>
					</p>
					<p class="mg-12">
                    ...
                    <p class="pj-content">
                        ...
                        <el-input type="textarea" :rows="5" :maxlength="500" style="width:680px"  placeholder="请输入备注内容" v-model="sm"></el-input>
                    </p>
                </section>
