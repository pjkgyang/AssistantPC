      ...
      <el-dialog
            ...
            <div class="dialog-pj">
                 <section flex> 
                    ...
                    <p class="pj-content">
                        <uploadFile :Type="'demand'" :isClearFile="isClearFile"  @handleUploadFile="handleUploadFile"></uploadFile>
                    </p>
                </section>

                <section> 
                    <p class="pj-content">
                       <el-input type="textarea" :rows="5" :maxlength="500" style="width:670px"  placeholder="请输入说明内容" v-model="formData.sm"></el-input>
                    </p>
                </section>
