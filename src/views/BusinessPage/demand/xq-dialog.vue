<template>
  <div class="dialog-container">
    ...
    <xqlistDilog
      :show.sync="demandListVisible"
      :xmbh="demandData.xmbh"
      @handleChooseDemand="handleChooseDemand"
    ></xqlistDilog>
  </div>
</template>
  ...
  methods: {
    handleChangeQwwcrq() {
      if (
        ...
        new Date(this.demandData.qwsjwcrq) > new Date(this.demandData.qwkfjfrq)
      ) {
    ...
    handleCommit() {
      ...
      this.demandData.cpbjbh = !this.cpData.length
        ? ""
        : this.cpData[this.cpData.length - 1].id;
      this.demandData.cpbjmc = !this.cpData.length
        ? ""
        : this.cpData[this.cpData.length - 1].title;
      ...
      if (this.show) {
        ...
        if (this.Type == "edit" || this.Type == "editDisabled") {
          ...
          this.demandData.xqfl =
            this.Type == "editDisabled" ? "3" : this.demandInfo.xqfl;
          ...
          this.glxqMc = !this.demandInfo.glxqbh
            ? ""
            : "[" + this.demandInfo.glxqbh + "]" + this.demandInfo.glxqbt; //关联需求名称
