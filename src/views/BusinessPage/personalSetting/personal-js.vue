      ...
      <section slot="bottom" class="personalJs-bottom" flex spacearound>
        ...
        <div class="personalJs-menu" style="padding-left: 20px;">
          ...
          <div class="personalJs-menu-sm">
            <section>
              <p>【规则】</p>
              <p>1.实结结算 = 分包实施费用 - 实施调用费用 - 预留费用;</p>
              <p>2.二开结算 = (分包二开费用 - 实际使用二开费用 - 预留费用) * (5400 / 0800);</p>
              <p>3.可变结算 = (分包可变费用 - 实际使用可变费用 - 预留费用) * 70%;</p>
              <p>4.结算费用 = 实施结算 + 二开结算 + 可变结算;</p>
              <p>5.结算金额总计(元) = 项目结算合计 + 其他人员调用 + 导师奖励 + 其他奖励;</p>
              <p>6.应发工资:结算金额总计 - 结算期已发金额[月工资 * (当月月份财年 - 起始月份)](财年起始月份:4月份);</p>
              <p>7.实发工资:如果低于工资按工资标准发放,否则按应发工资发放;</p>
            </section>
            <section>
              <p>【案例】</p>
              <p>张三月工资12000元,只有一个分包,6月份结算数据如下:</p>
              <p>分包实施费用30000元,实施调用费用6000元,预留4000元;</p>
              <p>分包二开费用20000元,实际二开费用8000元,预留2000元;</p>
              <p>分包可变费用20000元,实际可变费用7000元,预留3000元;</p>
              <p>奖励0元,惩罚0元,其他人员调用2000元,导师奖励1000元,其他奖成0元;</p>
