<template>
    <div class="rbpzDetail">
        <div>
            <div>
                <ybTable :tableData="tableData" @handleCheckpzDetail="handleCheckpzDetail"></ybTable>
            </div>
            <div text-right>
...
<script>
import ybTable from "@/components/xmjdTable/ybList.vue";
