<template>
    <div>
       <div>
        ...
        <div>
            <tableComponent :tableData="dataList" :tableHead="headList" :pageShow="false" @handleXxwt="handleXxwt" @exportTable="exportTable"></tableComponent>
...
export default {
    ...
    methods:{
        exportTable(){
            ...
            window.open(window.baseurl+'report/exportCptsqlReport.do?qyzd='+this.filterDate.gczd+'&startDt='+startDt+'&endDt='+endDt+
            '&xmlx='+this.filterDate.xmlx+'&dwlx='+this.filterDate.dwlx);
        },
