    ...
    <div>
       <div class="query-condition"> 
           <div>
                ...
                <el-input v-model="keyword" size="mini" style="width:260px;" placeholder="请输入学校名称/项目名称/项目编号" @change="handleSearch"></el-input>&#x3000;
        ...
        <div>
            <tablexjpmXm :tableData="xmpmList" @handleWtpfXm="handleWtpfXm" :nowPage="nowPage"></tablexjpmXm> 
...
import tablexjpmXm from "@/components/reportTable/table-xjpm-xm.vue";
...
export default {
    ...
    methods:{
        ...
        handleSearch(){
            this.nowPage = 0
            this.WtReportOrderStar(1);    //学校报表
        },
        handleSearchBtn(){
            this.nowPage = 0
            this.WtReportOrderStar(1);    //学校报表
        },
        handleWtpfXm(param){ //问题受理人报表
        ...
        exportTable(){  // 导出
         window.open(window.baseurl+'report/exportWtReportOrderStar.do?gbsjStart='+this.ksrqValue+'&gbsjEnd='+this.jsrqValue+
                      '&cpxbh='+this.cpx+'&dwlx='+this.dwlx+'&xmlx='+this.xmlx+'&qyzd='+this.gczd+'&lx=4'+'&keyword='+this.keyword);
        },
        handleGCZD(e){
      ...
      WtReportOrderStar(curPage){       //  问题评分--项目
      ...
      activated(){},
      watch:{},
      components: { tablexjpmXm,pagination }
}
</script>
<style scope>
.query-condition>div{
