...
export default {
    ...
    methods:{
        exportTable(){
            ...
            window.open(window.baseurl+'report/exportQytsqlReport.do?startDt='+startDt+'&endDt='+endDt+
            '&xmlx='+this.filterDate.xmlx+'&dwlx='+this.filterDate.dwlx+'&cpx='+this.filterDate.cpx);
        },
