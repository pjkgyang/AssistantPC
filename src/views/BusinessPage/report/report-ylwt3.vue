<template>
    <div>
       <div class="query-condition">
        ...
        <div>
            <report-ylwt3 :tableData3="ylwtList3" @handleCpxygz="handleCpxygz"></report-ylwt3>
        </div>
    </div>    
</template>
<script>
...
import reportYlwt3 from "@/components/reportTable/report-ylwt3.vue";
export default {
    data(){
        return{
             gczdList:[],
    ...
    methods:{
        ...
        exportTable(){  // 导出
           window.open(window.baseurl+'report/exportylWtReportByCpx.do?dwlx='+this.dwlx+'&qyzd='+this.gczd+'&sjlb='+this.sjlb+'&lx=3');
        },
        handleDWLX(e){
