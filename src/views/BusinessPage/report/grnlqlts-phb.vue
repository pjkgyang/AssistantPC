    ...
    <div>
       <div>
        ...
        <div>
            ...
            :height="'380px'" @handleXxwt="handleXxwt" @exportTable="exportTable"></tableComponent>
...
export default {
    ...
    methods:{
         exportTable(){
            ...
            window.open(window.baseurl+'report/exportGrtsqlReport.do?qyzd='+this.filterDate.gczd+'&startDt='+startDt+'&endDt='+endDt+
            '&xmlx='+this.filterDate.xmlx+'&dwlx='+this.filterDate.dwlx+'&cpx='+this.filterDate.cpx+'&keyword='+this.filterDate.keyword);
        },
        handleCurrentChange(data){
            this.grtsqlReport(data);
