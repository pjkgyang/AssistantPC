<template>
    <div>
       ...
       <div>
            <report-table :tableData="reportList" @handleWtgz="handleWtgz"></report-table> 
        </div>
    </div>    
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        exportTable(){  // 导出
           window.open(window.baseurl+'report/exportylWtReportByCpx.do?dwlx='+this.dwlx+'&qyzd='+this.gczd+'&lx=0');
        },
        handleDWLX(e){
