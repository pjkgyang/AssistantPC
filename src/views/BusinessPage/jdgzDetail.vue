<template>
    <div class="pd-10">
        <div class="dialog-jd">
            ...
            <h4 v-else>{{this.$route.query.personType == 1?'实施 — ':'用户 — '}}
              {{this.$route.query.filterType==1?'催办':
              this.$route.query.filterType==2?'已超期':
              this.$route.query.filterType==7?'待确认任务数':
              this.$route.query.filterType==8?'已确认任务数':
              this.$route.query.filterType==0?'总数':
              this.$route.query.filterType==5?'个人任务总数':'未完成个人任务总数'}}</h4>
            ...
            <el-table :data="tableData" border style="width: 100%" :min-height="500" :max-height="tableHeight" v-if="this.$route.query.lcbqr == '1'" key="jdqr-table">
                <el-table-column prop="xmbh" label="项目编号" width="140"></el-table-column>
                <el-table-column prop="xmmc" label="项目名称" min-width="340" show-overflow-tooltip></el-table-column>
                <el-table-column prop="cpmc_display" label="产品名称" width="240" show-overflow-tooltip></el-table-column>
                <el-table-column prop="lcbms_display" label="里程碑" width="180" show-overflow-tooltip></el-table-column>
                <el-table-column prop="zt_display" label="状态" width="100"></el-table-column>
