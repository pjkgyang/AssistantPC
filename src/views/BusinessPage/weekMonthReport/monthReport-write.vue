...
export default {
  ...
  methods: {
    ...
    isMonthPlanBlocked(month, isPrev) {
      // 是否封存
      isMonthPlanBlocked({
        month: month
      }).then(({ data }) => {
    ...
    getDate() {
      ...
      this.lastMonth =
        oldYear + "-" + (oldMonth < 10 ? "0" + oldMonth : oldMonth);
