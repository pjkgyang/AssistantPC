  ...
  <div class="project-question">
      ...
      <div class="query-condition" v-if="queryLJshow">
        ...
        <div>
          ...
          <p class="query-list" @click="handleZXR">
            ...
            <span
              v-for="(wtflx,index) in wtflList"
              :data-type="wtflx.label"
              :key="index"
              :class="{'bg-active':wtfl == wtflx.label}"
            >{{wtflx.mc}}</span>
          </p>
        </div>
        ...
        <div>
          ...
          <p class="query-list" @click="handleLcbh">
            ...
            <span
              v-for="(lcbhx,index) in lcbhList"
              :data-type="lcbhx.label"
              :class="{'bg-active':lcbh == lcbhx.label}"
            >{{lcbhx.mc}}</span>
          </p>
        </div>
        ...
        <div>
          ...
          <p class="query-list" @click="handleWtjb">
            ...
            <span
              v-for="(wtjbc,index) in wtjblist"
              :data-type="wtjbc.label"
              :class="{'bg-active':wtjb === wtjbc.label}"
            >{{wtjbc.mc}}</span>
          </p>
        </div>
        <div v-if="showCondition==1||showCondition==2">
          ...
          <p class="query-list" @click="handleWXYZT">
            ...
            <span
              v-for="(item,index) in wxyztlist"
              :data-type="item.label"
              :class="{'bg-active':wxyztbg == item.label}"
            >{{item.mc}}</span>
          </p>
        </div>
        <div v-if="showCondition==1||showCondition==2">
          ...
          <p class="query-list" @click="handleWJJZT">
            ...
            <span
              v-for="(item,index) in wjjztlist"
              :data-type="item.label"
              :class="{'bg-active':wjjztbg == item.label}"
            >{{item.mc}}</span>
          </p>
        </div>
        <div v-if="isJZuser == 0">
          ...
          <p class="query-list" @click="handleCNQX">
            ...
            <span
              v-for="(item,index) in cnqxList"
              :data-type="item.label"
              :class="{'bg-active':cnqx == item.label}"
            >{{item.mc}}</span>
          </p>
        </div>
    ...
    >
      <div style="padding:0 10px">
        ...
        <el-button
          v-if="this.userGroupTag.includes('ProblemAdmin')||userGroupTag.includes('GCCPZJ')||userGroupTag.includes('QYZ')"
          size="mini"
          type="primary"
          @click="handleExport"
...
export default {
  ...
  mounted() {
    ...
    if (!getSession("QuestionWorkflow")) {
