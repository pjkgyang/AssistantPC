          ...
          <li v-for="(question,index) in questionList">
              ...
              <div class="question-info">
                  ...
                  <span class="question-tag-ysqgb" v-if="question.sqgbCount > 0">已申请关闭</span>
                   <div>
                        <span style="color:#000"><span class="question-info-front">所属项目 &#x3000;</span>{{qusetionInfo.xmmc}}</span>
                    </div>
                  <p>
...
import { queryAllQuestions,deleteQuestion,queryQuestion ,showQuestionCondition,canSubmitQuestion} from '@/api/xmkb.js'
...
export default {
  ...
  methods:{ 
      handleExport(){
          ...
          '&sqgb='+this.sqgb+'&deadline='+this.cnqx+'&starDay='+this.starDay+'&endDay='+this.endDay+'&xmbh='+this.xmbh)  
      },
      handleTWsuccess() {
      // 提问 编辑成功
