<template>
  <div>
    <div class="project-question">
        ...
        <ul class="project-question-detail">
          ...
          <li>
            <div class="project-question-detail-top">
              ...
              <div class="question-content">
                <span style="font-size:18px;color:#363748">{{ qusetionInfo.bt }}</span>
                <br />
                ...
                <p>
                  ...
                  <span>
                    ...
                    {{ wtjbmc == '' || wtjbmc == null ? '无' : wtjbmc }}
                  </span>
                  <span>
                    <span class="question-info-front">版本号 &#x3000;</span>
                    {{ qusetionInfo.bbh }}
                  </span>
                </p>
                <p>
                  <span>
                    <span class="question-info-front">期望解决日期&#x3000;</span>
                    {{ qusetionInfo.qwjjrq == '' ? '无' : qusetionInfo.qwjjrq }}&#x3000;
                  </span>
                  <span>
                    <span class="question-info-front">承诺结束日期&#x3000;</span>
                    {{ qusetionInfo.cnjsrq == '' ? '无' : qusetionInfo.cnjsrq }}
                  </span>
                  <span>
                    <span class="question-info-front">问题来源 &#x3000;</span>
                    {{ wtlymc == '' || wtlymc == null ? '无' : wtlymc }}
                  </span>
                </p>

                <p>
                  <span>
                    <span class="question-info-front">解决责任人 &#x3000;</span>
                    {{ qusetionInfo.jjzrr }}
                  </span>
                  <span v-if="hffjshow">
                  ...
                  <span>
                    <span class="question-info-front">项目状态 &#x3000;</span>
                    {{ qusetionInfo.xmzt }} &#x3000; &#x3000;
                    <span class="question-info-front">是否有服务 &#x3000;</span>
                    {{ !qusetionInfo.sfyfw ? '无' : '有' }}
                  </span>
                </p>
                <p>
                  <span>
                    ...
                    <span class="item-wtbq-tag">
                      <el-tag style="margin:0 10px 5px 0;" v-for="(tag, i) in wtbq" :key="i" :closable="tag.sjly == 2 || (User.indexOf('ProblemAdmin') != -1 && tag.sjly != 0)"
                        size="mini" :type="tag.type" :title="tag.sjly == 0 ? '点击添加标签' : ''" @click.native="handleClick(i)"
                ...
                <div flex>
                  <p style="width:85%;padding-top:5px">
                    ...
                    <span v-if="reply.hflx == 2 || reply.hflx == 6 || reply.hflx == 7 || reply.hflx == 12 || reply.hflx == 13">
                      <span>
                        {{ reply.hflx == 2 ? '转发至：' : reply.hflx == 7 ? '催办人：' : reply.hflx == 12 || reply.hflx == 13 ? '发送至：' : '责任人：' }}
                      </span>
                      {{ reply.sfjsr }}
                    </span>
                  </p>
                  ...
                  <span v-if="reply.wtjjj != 2 && !isCjwt" flex-align-center>
                    <el-button @click="handleSetResolve($event, reply, '')" :disabled="reply.wtjjj == 0" size="mini">
                      {{ reply.wtjjj == 0 ? '已设为常见问题' : reply.wtjjj == 1 ? '设置为常见问题' : '' }}
                    </el-button>
                    &#x3000;
                  </span>
                  ...
                  <span v-if="(reply.hflx == 3 || reply.hflx == 10) && qusetionInfo.fbzt != 1" flex-align-center>
                    <el-button type="primary" v-if="reply.sfbh == 0" @click="handleRejectQuestion(reply.wid, index)"
          ...
          <li v-if="qusetionInfo.fbzt == 1">
            <div class="project-question-detail-top" style="background:#F5F7FA;padding:10px 0;">
              <div class="question-type"><span class="question-reply">关闭</span></div>
              <div class="question-content-SC">
                <p>
            ...
            <div class="project-question-detail-bottom" style="padding:0 30px;">
              ...
              <section v-if="zlpf <= 3 && !!qusetionInfo.cpsm">
                ...
                <div style="padding:0 !important;text-indent:12px" :class="{ isRedColor: !!qusetionInfo.cpsm }">
                  {{ !qusetionInfo.cpsm ? '无' : qusetionInfo.cpsm }}
                </div>
              </section>
          ...
          <div style="margin-top:15px;" class="question-note">
            <div style="margin:5px 0;" v-if="username != qusetionInfo.fbrxm && qusetionInfo.fbzt != 1 && (isJZuser == 0 || isJZuser == 2)">
              实施工时 :
              <el-input v-model="gsValue" placeholder="请输入内容" size="mini" style="width:100px"></el-input>
              &nbsp; 是否bug :
      ...
      <el-dialog width="600px" title="问题评价" :visible.sync="innerVisible" :close-on-click-modal="false" append-to-body>
        <div class="question-evaluate">
          ...
          <div class="question-rate" v-if="fwzlValue <= 3">
            <p><span class="filter-weight before-require">评价说明：</span></p>
            <p>
          ...
          <div>
            ...
            <span style="color:#f00">{{ ContributionPeople.length }}</span>
            人
            <el-table :data="ContributionPeople" style="width: 100%" border :max-height="580" border>
              ...
              <el-table-column label="工时(小时)">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.qrgs" :class="{ 'is-outline': questionReply.length != 0 && questionReply[0].sfhf == 1 }"
                    size="mini" :readonly="questionReply.length != 0 && questionReply[0].sfhf != 1"></el-input>
                </template>
              </el-table-column>
            </el-table>
          </div>
          <div class="question-rate">
            <p><span class="filter-weight">工时认可：</span></p>
      ...
      <!-- 受理 -->
      <el-dialog width="600px" :title="isSltitle" :visible.sync="innerCNRQVisible" :close-on-click-modal="false"
        append-to-body>
        <div style="padding:10px;">
          <div v-if="isSLvisible">
            <span class="filter-bt" style="display:inline-block;">期望解决日期 :</span>
            <el-date-picker v-model="xgqwjjrq" type="date" placeholder="选择日期" format="yyyy-MM-dd" :clearable="false"
              size="mini" readonly></el-date-picker>
          </div>

          <div v-if="false" style="display:flex;margin-bottom:15px;">
            <span>环境信息 :</span>
            <el-upload style="width:510px;" class="upload-demo" ref="upload" :limit="1" :action="uploadAction"
              :before-upload="beforeUpload" :on-remove="handleRemove" :on-change="handleChange" :file-list="fileList"
          ...
          <div style="margin:15px 0;">
            ...
            <el-date-picker :picker-options="pickerBeginDateBefore" v-model="xgcnjsrq" type="date" placeholder="选择日期"
          ...
          <div v-if="isSLvisible" style="margin:15px 0">
            ...
            <el-select v-model="slWtly" size="mini" placeholder="请选择问题来源" style="width:220px">
              <el-option v-for="(item, index) in wtlyList" :key="index" :label="item.mc" :value="item.label"></el-option>
            </el-select>
          </div>
      ...
      <!-- 转发问题 -->
      <el-dialog width="1000px" title="转发问题" :visible.sync="innerZFWTisible" :close-on-click-modal="false"
        append-to-body>
        <div style="padding:10px;" class="question_transmit">
          ...
          <div class="question-zf">
            <span class="before-require filter-weight span_label" style="display:inline-block;margin:10px 0 !important;">转发说明:
              &nbsp;&nbsp;</span>
      ...
      <el-dialog title="选择项目" :visible.sync="dialogQuestionVisible" :close-on-click-modal="false" width="1000px" top="30px"
        append-to-body>
        <div style="padding:10px;">
          <itemChoose @handleEdit="handleEdit"></itemChoose>
        </div>
      </el-dialog>
      <el-dialog :title="zdTitle" :visible.sync="zdfzrVisible" :close-on-click-modal="false" width="800px" top="30px"
        @close="ClosezdfzrVisible" append-to-body>
        <div style="padding:10px;">
          <zdfzrChoose :lchjList="lchjList" :visible="zdfzrVisible" :tableData="tableData" :zdTitle="zdTitle" :jkrTotal="jkrTotal"
            @handleYYRYLX="handleYYRYLX" @handleClose="handleClose" @handleCommitZdr="handleCommitZdr"
            @queryComplainZRR="queryComplainZRR" @queryComplainUser="queryComplainUser" @handleCurrentChange="handleZrrChange"></zdfzrChoose>
        </div>
      </el-dialog>

      <el-dialog title="申请关闭" :visible.sync="sqjsVisible" :close-on-click-modal="false" width="800px" top="30px"
        append-to-body>
        <div style="padding:10px;">
      ...
      <!-- 关联开发任务 -->
      <el-dialog title="提报crowd任务" :visible.sync="crowdVisible" :close-on-click-modal="false" width="1000px" top="30px"
        append-to-body>
            ...
            <el-form :model="crowdxqData" :rules="rules" ref="crowdxqData" class="demo-ruleForm">
              ...
              <el-form-item>
                <el-date-picker @change="handleChoosejfDate2" value-format="yyyy-MM-dd" :picker-options="pickerJfrqDateBefore"
                  size="mini" type="date" placeholder="请输入预期交付日期日期，中标者将严格按照该日期交付需求相关信息" v-model="crowdxqData.jfrq"
                  style="width: 100%;"></el-date-picker>
              </el-form-item>
              <el-form-item>
      ...
      <el-dialog :title="'进度跟踪' + '[' + crowdId + ']'" :visible.sync="jdgzVisible" :close-on-click-modal="false" width="800px"
        top="30px" append-to-body>
        <div style="padding:20px 10px ">
          <div class="CrowdRwxx">
            <span>任务名称 :</span>
      ...
      <el-dialog title="编辑回复内容" :visible.sync="editEplyVisible" :close-on-click-modal="false" width="800px" top="30px"
        append-to-body>
      ...
      <el-dialog title="申请待验证" :visible.sync="sqdyzVisible" :close-on-click-modal="false" width="600px" top="30px"
        append-to-body>
        <div style="padding:20px 10px" class="question-sqdyz">
          <span class="question-sqdyz-title">版本发布日期:</span>
          <el-date-picker v-model="sqdyzValue" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" :clearable="false"
      ...
      <el-dialog title="提示" :visible.sync="dialogVisibleGq" width="500px" :before-close="handleClose">
        <div class="mg15">
          ...
          <div>
            <span class="filter-bt before-require">说明 :</span>
            <el-input type="textarea" style="width: 350px;" :rows="2" placeholder="请输入内容" v-model="gqData.sm"></el-input>
          </div>
          <div></div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleCloseTag(index) {
        if (this.User.indexOf('ProblemAdmin') == -1 && this.User.indexOf('ZJZBZ') == -1 && this.User.indexOf('ZJ') == -
          1) {
          this.$message({
      ...
      handleSaveReplyContent() {
        ...
        this.replySet(this.questionReply[this.isEditReplyIndex].wid, $('#summernoteEditReplay').summernote('code'),
          false, this.replygs);
      },
      //删除回复
      ...
      replySet(wid, nr, isDel, gs) {
        replySet({
          ...
          if (data.state == 'success') {
            if (!isDel) {
              this.questionReply[this.isEditReplyIndex].nr = $('#summernoteEditReplay').summernote('code');
          ...
          .then(({
            ...
            applyDismiss({
              ...
              if (data.state == 'success') {
                ...
                this.questionReply[param].nr = this.questionReply[param].nr + '<br>说明 : ' + this.bhsm;
              } else {
                this.$alert(data.msg, '提示', {
                  confirmButtonText: '确定',
                  type: 'error'
      ...
      CommitChangeCNjsrq() {
        ...
        if (this.isSltitle == '修改承诺时间') {
          ...
          this.$confirm('期望解决日期:' + this.xgqwjjrq + '你的承诺解决日期:' + this.xgcnjsrq + ',确认受理吗？', '提示', {
              ...
              customerQuestion({
                wid: this.wid,
                nr: $('#summernoteT').summernote('code') == '<p><br></p>' ? '' : $('#summernoteT').summernote(
                  'code'),
                cnjsrq: this.xgcnjsrq,
                qwjjrq: this.xgqwjjrq,
                wtly: this.slWtly, //问题来源
                hjfjwid: '',
                Guid: this.gsValue
              }).then(({
                data
      ...
      saveCb(ryData) {
        ...
        saveCb({
          wid: this.wid,
          nr: $('#summernoteT').summernote('code') == '<p><br></p>' ? '' : $('#summernoteT').summernote('code'),
          ryData: ryData
        }).then(({
          data
        }) => {
        ...
        this.$confirm('确定要关闭此问题吗?', '提示', {
          ...
          .then(() => {
            ...
            closeQuestion({
              ...
              gxrData: gxrArr.join('|'),
              sfjj: '',
              jjsm: $('#summernoteT').summernote('code') == '<p><br></p>' ? '' : $('#summernoteT').summernote(
                'code'),
      ...
      queryProcess(wid) {
        queryProcess({
          ...
          if (data.state == 'success') {
            ...
            this.lchjList = this.questionProcess.slice(0, this.questionProcess.length - 2);
          }
        });
      },
      ...
      queryQuestion(wid, xmtd) {
        ...
        queryQuestion({
          ...
          if (data.state == 'success') {
            ...
            try {
              this.qusetionInfo.nr = decodeURIComponent(this.qusetionInfo.nr).replace(
          ...
          if (data.state == 'success') {
            ...
            if (data.data != null && data.data.length != 0) {
              this.questionReply.forEach((ele, i, arr) => {
                try {
                  ele.nr = decodeURIComponent(ele.nr).replace('/gcgl/sys/emapcomponent/file/getFileByToken/',
                    '/emap/sys/emapcomponent/file/getFileByToken/');
                } catch (err) {
                  ele.nr = ele.nr;
                }
