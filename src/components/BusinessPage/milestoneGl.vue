<template>
  <div class="milestone-manage">
       <section style="border-radius:5px;padding:8px 0;background:#fff;box-shadow:0 0 5px #ccc">     
            <div class="filter">
              <span class="filter-title">高级查询: </span><el-input size="small" style="width:50%" placeholder="请输入项目内容/里程碑描述"  suffix-icon="el-icon-search" v-model="keyword" @change="searchLcbContent"> </el-input>
