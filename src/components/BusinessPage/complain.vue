       ...
       <ul>
         <li v-for="(complain,index) in complainList">
           ...
           <div class="complain-content">
             <p :data-wid="complain.wid" @click="getComplaint"><span>{{complain.tsbt}}</span></p>
...
export default {
  data(){
    return{
       note:{
            backgroundImage: "url(" + require("../../../static/img/replyIcon.png") + ")",
        },
        total:null,
        pageSize:8,
        currentPage:1,
...
.complain-detail-cont>p:nth-of-type(1),.complain-detail-cont span{
  color: #000;
}
