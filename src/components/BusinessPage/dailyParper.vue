<template>
	<div style="width:90%;margin:0 auto;padding:20px 0;">
		<el-form ref="formData" label-width="80px" class="demo-formData" :inline="true">
			...
			<el-form-item label="工时" required><el-input v-model="gs" style="width:172px;"></el-input></el-form-item>
			<el-form-item label="日志内容" required><el-input type="textarea" v-model="desc" :rows="12" style="width:450px"></el-input></el-form-item>
			...
			<div flex>
				<p style="min-width:80px;text-align:right;font-weight:700;padding-right:12px;white-space:nowrap"><span class="before-require">关联任务</span></p>
				<p>
