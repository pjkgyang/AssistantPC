  ...
  <div style="width:90%;margin:0 auto;padding:20px 0;">
    <el-form ref="formData" label-width="80px" class="demo-formData" :inline="true">
      ...
      <el-form-item label="上传附件">
        <el-upload class="upload-demo" ref="upload" multiple :action="uploadAction" :before-upload="beforeUpload" :on-remove="handleRemove" :on-change="handleChange" :file-list="fileList" :show-file-list="true" :auto-upload="false">
...
export default {
  ...
  mounted() {
    ...
    this.taskname = !this.logInfo.xmmc
      ? ""
      : this.taskName
        ? this.taskName
        : this.logInfo.xmmc +
