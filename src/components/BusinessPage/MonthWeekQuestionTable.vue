  ...
  <el-table
    ...
    <el-table-column fixed="left" label="操作" width="150">
      <template slot-scope="scope">
        <span v-if="deleteShow && !scope.row.szjh" ><el-button @click="handleClickDelete(scope.row,scope.$index)" type="text" style="color:red" size="small" >删除</el-button></span>
        ...
        <span v-if="isEdit && bjWordShow"><span class="table-hr" v-if="(deleteShow||isPz)&&!scope.row.szjh"> 丨 </span><el-button @click="handleClickEdit(scope.row,scope.$index)" type="text" size="small">{{isZj?'总结':'计划'}}</el-button></span>
