        ...
        <td :colspan="colSpan">
          <table>
            <tr
              class="leve"
              :class="levelClass"
              :style="{'background':model.Experience==1?'#d2dcfa':'','font-weight':model.Experience==1?'700':''}"
            >
              <td class="td1">
                <div :class="{ 'td-title': true }" colcenter>
                  ...
                  ></span>
                  &nbsp;
                  <a class="ellipsis" @click="handlerChooseModel(model)">
...
export default {
  ...
  methods: {
    ...
    handlerChooseModel(m) {
      this.$emit("handlerChooseModel", m);
    },
