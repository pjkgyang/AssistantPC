        ...
        <div class="pannelPaddingBg-10">
            ...
            <div>
                <el-table :data="tableData" border style="width: 100%"  :max-height="tableHeight">
                    <el-table-column prop="xm" label="姓名" min-width="100"></el-table-column>
                    <el-table-column prop="bh" label="工号" min-width="100"></el-table-column>
                    <el-table-column prop="ssbm" label="所属部门" width="110"></el-table-column>
                    <el-table-column prop="ssyjbm" label="所属一级部门" width="110"></el-table-column>
                    ...
                    <el-table-column prop="qyzd" label="区域战队"  width="140" ></el-table-column>
                    <el-table-column prop="zxmc" label="职系名称"  width="100" ></el-table-column>
                    ...
                    <el-table-column prop="byyx" label="毕业院校" min-width="180"></el-table-column>
                </el-table>
                <div text-right>
