            ...
            <el-table :data="tableData" border style="width: 100%">
              <el-table-column fixed="left" label="操作" width="100">
                <template slot-scope="scope">
                  <el-button type="success" size="mini" @click="handleTrain(scope.row)">培训</el-button>
                </template>
              </el-table-column>
              <el-table-column prop="cpmc" label="产品" min-width="180"></el-table-column>
              <el-table-column prop="pxzt" label="培训主题" min-width="300" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column prop="pxsp" label="培训视频" width="180"></el-table-column>
            </el-table>
          </div>
        </section>
      </tableLayout>
...
export default {
  data() {
    return {
      sspxShow: false,
      filterList: ["keyword", "cp", "pxxs", "jhcjrq", "fbrq", "sjpxrq", "jhzt"],
      tableData: [],
      currentPage: 1,
      pageSize: 15,
      total: 0,
  ...
  methods: {
    ...
    pageCapacityPlan() {
      this.$get(this.API.pageCapacityPlan, {
        ...
        jhpxsjStart: this.filterWord.fbrq[0],
        jhpxsjEnd: this.filterWord.fbrq[1],
  ...
  components: { filterCondition, tableLayout, sspxDialog }
};
</script>
